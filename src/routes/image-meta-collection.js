...
const imageMetaCollection = {
	...
	ccp_ouatacc_white: instantiateObject(jdgImageMeta, {
	...
	ccp_blue_mall_60s70s_1: instantiateObject(jdgImageMeta, {
	...
	ccp_blue_mall_80s90s_1: instantiateObject(jdgImageMeta, {
	...
	ccp_gold_mall_60s70s_1: instantiateObject(jdgImageMeta, {
	...
	ccp_gold_mall_80s90s_1: instantiateObject(jdgImageMeta, {
	...
	lakeside_1: instantiateObject(jdgImageMeta, {
	...
	rose_mall_60s70s_1: instantiateObject(jdgImageMeta, {
	...
	rose_mall_60s70s_2: instantiateObject(jdgImageMeta, {
	...
	fairgrounds_aerial: postProcessImageMeta(
		instantiateObject(jdgImageMeta, {
	...
	speer_point_before: postProcessImageMeta(
		instantiateObject(jdgImageMeta, {
	...
	speer_point_after: postProcessImageMeta(
		instantiateObject(jdgImageMeta, {
	...
	plan_60s70s_1: instantiateObject(jdgImageMeta, {
	...
	exp: {
		broadway_southwest_before_1: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		broadway_southwest_before_2: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		broadway_southwest_concept_1_aerial: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		broadway_southwest_concept_1_market: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		broadway_southwest_concept_1_promenade: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		broadway_southwest_concept_2_promenade: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		corporate_showroom_before: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		corporate_showroom_corner: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		corporate_showroom_elevation: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		encode_campus_after: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fifteen_platte_dynamo: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fifteen_platte_grayscale: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fifteen_platte_sunset: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_campus_before_aerial: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_campus_before_1: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_campus_before_2: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_campus_before_3: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_campus_before_4: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_campus_aerial: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_campus_lawn: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_campus_kenyon_corner: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_campus_massing: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_campus_plaza: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_campus_paseo: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_campus_south_wing: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		o2_research: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		ranch_elsie_option_3: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		ranch_elsie_roof_optioneering: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		sixteen_pearl_before: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		sixteen_pearl_corner: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		sixteen_pearl_interior: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		sixteen_pearl_terrace: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
	...
	hst: {
		fms_2000s_plan_additions: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		ehs_1936_southeast_wing: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		ehs_1950s_broadway_entrance: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_1960s_broadway_entrance: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_1960s_broadway_entrance_renovation: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_1968_southeast_corner_entrance: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		fms_2013_broadway_northeast: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
		...
		ehs_1919_plan: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
	...
	ind: {
		planter_003F_1: postProcessImageMeta(
			instantiateObject(jdgImageMeta, {
	...
	swe: {
		ccp_1: instantiateObject(jdgImageMeta, {
