...
const imageMetaRegistry = {
	...
	ccm: {
		_1968_03_07_von_frellick: {
			...
			src: 'https://res.cloudinary.com/jdg-main/image/upload/v1765685193/jdg-ui-svelte/ccm/1968-03-07-von-frellick-2.png',
			alt: 'Gerri Von Frellick stands on a Blue Room stair landing while grand opening festivities take place below.',
			caption:
				'Gerri Von Frellick stands on a Blue Room stair landing while grand opening festivities take place below.',
			attribution: 'Englewood Public Library'
		},
		...
		_1983_05_19_blue_mall_and_food_court: {
			...
			src: 'https://res.cloudinary.com/jdg-main/image/upload/v1765691026/jdg-ui-svelte/ccm/1983-05-19-blue-mall-and-food-court.jpg',
