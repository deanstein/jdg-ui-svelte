...
export const getDistanceToTopOfHeader = () => {
    ...
    uiState.subscribe((currentValue) => {
        distanceToTop.value = currentValue.activeNotificationBanners.length > 0
...
export const getDistanceToBottomOfHeader = () => {
    ...
    distanceToBottom.value = (getDistanceToTopOfHeader().value + jdgSizes.nHeaderHeight + 2 * jdgSizes.nHeaderTopBottomPadding);
